...
RESULTS_DIR = f"{ROOT_DIR}/results/20260311_dispatch/results/dispatch/networks"
...
def get_network_fps_for_year(year: int) -> dict[str, str]:
    ...
    return {
        "n_sq_dispatch": f"{RESULTS_DIR}/SQ/{year}.nc",
        "n_iem_dispatch": f"{RESULTS_DIR}/IEM/{year}.nc",
        "n_iem_fb_dispatch": f"{RESULTS_DIR}/TF/{year}.nc",
        "n_sq_redispatch": f"{RESULTS_DIR}/SQ/{year}.nc",
        "n_iem_redispatch": f"{RESULTS_DIR}/IEM/{year}.nc",
        "n_iem_fb_redispatch": f"{RESULTS_DIR}/TF/{year}.nc",
    }
